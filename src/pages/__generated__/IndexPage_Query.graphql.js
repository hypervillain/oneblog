/**
 * @flow
 * @relayHash 903521c616601a497b8172b80051f598
 */
...
export type IndexPage_QueryVariables = {|
  repoName: string,
  repoOwner: string,
|};
export type IndexPage_QueryResponse = {|
  +gitHub: ?{|
    +repository: ?{|
  ...
  |}
|};
export type IndexPage_Query = {|
  variables: IndexPage_QueryVariables,
  response: IndexPage_QueryResponse,
|};
*/
...
return {
  ...
  "params": {
    "operationKind": "query",
    "name": "IndexPage_Query",
    "id": "4354512b-6f14-47db-87ab-1ba0d57d1021",
    "text": null,
    "metadata": {}
  }
};
...
// prettier-ignore
(node/*: any*/).hash = '1f241e61c709c8c17420904209f778e3';
module.exports = node;
